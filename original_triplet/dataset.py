...
def load_audio(filename, start = 0, stop = None, resample = True):
    ...
    # This function reads audio file and return data in numpy.float32 array. sr is the frequency
    y = y[:, 0]
    return y, sr
...
def process_test_dataset():
    ...
    for speaker in os.listdir(TEST_WAV):
        ...
        if not os.path.exists(os.path.join(TEST_FEATURE, speaker)): #if not exist create dir of the speaker
